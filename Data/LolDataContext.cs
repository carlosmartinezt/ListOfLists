...
namespace list_of_lists.Data {
    public partial class LolDataContext : DbContext {
        public LolDataContext() {
        }

        public LolDataContext(DbContextOptions<LolDataContext> options)
            : base(options) {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            if (!optionsBuilder.IsConfigured) {
                optionsBuilder.UseSqlServer("Data Source=77.75.120.158; Database=Lists; User Id=carlos; password=juliovoltio");
            }
        }
